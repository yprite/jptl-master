...
P1-JLPT-028: 프론트엔드 사용자 학습 이력 UI 구현 (포인트: 5, 상태: 백로그)
...
P1-JLPT-029: 프론트엔드 사용자 프로필 관리 UI 구현 (포인트: 3, 상태: 백로그)
...
P1-JLPT-027: 프론트엔드 사용자 성능 분석 UI 구현 (포인트: 5, 상태: 완료)
P0-JLPT-029: 프론트엔드 모든 페이지 시나리오 테스트 작성 (포인트: 8, 상태: 완료)
P1-JLPT-028: 프론트엔드 사용자 학습 이력 UI 구현 (포인트: 5, 상태: 진행중)
P1-JLPT-029: 프론트엔드 사용자 프로필 관리 UI 구현 (포인트: 3, 상태: 진행중)
총_포인트: 55
완료_포인트: 39
